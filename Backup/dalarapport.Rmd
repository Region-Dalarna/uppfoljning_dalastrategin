...
nystartade <- read_excel("Data/NystartadeFöretag2.xlsx")
...
utslapp1 <- SkapaStapelDiagram(skickad_df = vaxthusgaser %>%
                    ...
                    #x_var_fokus="fokus",
                    lagg_pa_logga = FALSE,
                    manual_y_axis_title = "Ton CO2",
                    manual_color = c(brewer.pal(9, "Greens"), "#000000"))
...
utslapp2 <- SkapaLinjeDiagram(skickad_df = vaxthusgaser %>% 
                    ...
                    diagram_titel = "Utsläpp per invånare (2008-2019)",
...
energialt <- SkapaStapelDiagram(skickad_df = elproduktion %>% 
                    ...
                    geom_position_stack = TRUE,
                    diagram_titel = "Elproduktion, Dalarnas län, 2012-2019",
                    output_mapp = "Diagram/",
                    filnamn_diagram = "elproduktion2.png",
                    diagram_capt = " Källa: Kolada\n Bearbetning: Thomas Lassi, Region Dalarna",
                    manual_y_axis_title = "MWh",
                    x_axis_lutning = 90,
                    manual_x_axis_text_hjust = 1.1,
                    manual_x_axis_text_vjust = 1.2,
                    lagg_pa_logga = FALSE)
...
effektivitet1alt <- SkapaStapelDiagram(skickad_df = effdalarna %>% mutate(effektivitet=effektivitet*1000),
                    skickad_x_var = "År",
                    skickad_y_var = "effektivitet",
                    diagram_titel = "Energieffektivitet, Dalarnas län (2008-2019)",
                    output_mapp = "Diagram/",
...
effektivitet3 <- SkapaStapelDiagram(skickad_df = effektivitet,
                    ...
                    skickad_y_var = "effektivitet",
                    diagram_titel = "Energieffektivitet, Sverige (2019)",
                    output_mapp = "Diagram/",
...
avfalldiag <- SkapaStapelDiagram(skickad_df = avfall,
                    ...
                    diagram_titel = "Insamlat grovavfall, Dalarnas län (2013-2020)",
                    output_mapp = "Diagram/",
...
avfallbrpdiag <- SkapaStapelDiagram(skickad_df = avfallbrp,
                    ...
                    diagram_titel = "Avfall/BRP, Dalarnas län, 2013-2019",
                    output_mapp = "Diagram/",
...
resande1alt <- SkapaStapelDiagram(skickad_df = resande,
                    ...
                    diagram_titel = "Resor med kollektivtrafik, Dalarnas län (2010-2020)",
                    output_mapp = "Diagram/",
...
resande2alt <- SkapaLinjeDiagram(skickad_df = resande %>% 
                    ...
                    diagram_titel = "Marknadsandel för kollektivtrafik, Dalarnas län (2010-2020)",
...
livsmedel1alt <- SkapaStapelDiagram(skickad_df = livsmedel,
                    ...
                    skickad_y_var = "Andel",
                    skickad_x_grupp = "År",
                    diagram_titel = "Teoretisk självförsörjning av livsmedel",
                    output_mapp = "Diagram/",
...
skogsmark1 <- SkapaStapelDiagram(skickad_df = skogsmark,
                    ...
                    diagram_titel = "Areal skyddad produktiv skogsmark, Dalarnas län (2018-2020)",
                    output_mapp = "Diagram/",
...
skogsmark2 <- SkapaStapelDiagram(skickad_df = skogsmark,
                    ...
                    diagram_titel = "Andel skyddad produktiv skogsmark, Dalarnas län (2018-2020)",
                    output_mapp = "Diagram/",
...
betesmark <- SkapaStapelDiagram(skickad_df = betesmark,
                    skickad_x_var = "year",
                    skickad_y_var = "value",
                    diagram_titel = "Arealen betesmark, Dalarnas län (2011-2020)",
                    output_mapp = "Diagram/",
...
chef4 <- SkapaStapelDiagram(skickad_df = chefsrep,
                    skickad_x_var = "grupp2",
                    skickad_y_var = "Andel",
                    skickad_x_grupp = "grupp",
                    #skickad_filter_OR_var = "region",
                    #skickad_filter_OR_vect = c("Dalarnas län"),
                    diagram_titel = "Chefsrepresentation, Dalarna, 2019",
                    output_mapp = "Diagram/",
...
gini1 <- SkapaLinjeDiagram(skickad_df = gini,
                    ...
                    diagram_titel = "Ginikoefficient (2011-2020)",
...
inter1 <- SkapaStapelDiagram(skickad_df = intindex %>% 
                    ...
                    skickad_x_var = "Lan",
                    skickad_y_var = "Index",
                    diagram_titel = "Regionalt index för internationalisering, Sverige (2020)",
                    output_mapp = "Diagram/",
...
inter2 <- SkapaStapelDiagram(skickad_df = intindex2 %>% 
                    ...
                    skickad_x_var = "Lan",
                    skickad_y_var = "Index",
                    diagram_titel = "Regionalt index för internationalisering, Sverige (2016-2020)",
                    output_mapp = "Diagram/",
                    filnamn_diagram = "inter1.png",
                    diagram_capt = " Källa: Tillväxtanalys\n Bearbetning: Thomas Lassi, Region Dalarna",
                    diagram_liggande = TRUE,
...
nystart1 <- SkapaStapelDiagram(skickad_df = nystartade,
                    skickad_x_var = "År",
                    skickad_y_var = "Antal",
                    diagram_titel = "Antal nystartade företag, Dalarnas län (1994-2020)",
                    output_mapp = "Diagram/",
...
matchning1 <- SkapaStapelDiagram(skickad_df = matchning,
                    ...
                    skickad_filter_OR_var = "region",
                    skickad_filter_OR_vect = c("Dalarnas län"),
                    diagram_titel = "Matchningsgrad, Dalarnas län (2015-2019)",
                    output_mapp = "Diagram/",
...
syss1 <- SkapaStapelDiagram(skickad_df = sysselsatt,
                    ...
                    skickad_filter_OR_vect = c("2020", "2019", "2018", "2017", "2016", "2015", "2014", "2013"),
                    diagram_titel = "Förvärvsarbetande (20-64 år), Dalarnas län (2013-2020)",
                    output_mapp = "Diagram/",
...
arb1 <- SkapaStapelDiagram(skickad_df = arbets,
                    ...
                    skickad_x_grupp = "gender",
                    skickad_filter_OR_var = "year",
                    skickad_filter_OR_vect = c("2020", "2019", "2018", "2017", "2016", "2015", "2014"),
                    diagram_titel = "Långtidsarbetslöshet (25-64 år), Dalarnas län (2014-2020)",
                    output_mapp = "Diagram/",
...
gymnasie$År <- as.character(gymnasie$År)

gym1 <- SkapaStapelDiagram(skickad_df = gymnasie,
                    skickad_x_var = "År",
                    skickad_y_var = "Andel",
                    diagram_titel = "Andel med fullföljd gymnasieutbildning inom fyra år (2011-2017)",
...
eftergym1 <- SkapaStapelDiagram(skickad_df = eftergym,
                    ...
                    skickad_filter_OR_var = "year",
                    skickad_filter_OR_vect = c("2020", "2019", "2018", "2017", "2016", "2015", "2014", "2013"),
                    diagram_titel = "Eftergymnasial utbildning, Dalarnas län (2013-2020)",
                    output_mapp = "Diagram/",
...
etab1 <- SkapaStapelDiagram(skickad_df = etablering %>% 
                              filter(region == "Dalarnas län", år>2012, kön=="män och kvinnor") %>% 
                    ...
                    skickad_x_grupp = "år",
                    diagram_titel = "Etablering på arbetsmarknaden, Dalarnas län (2013-2020)",
                    diagram_capt = " Källa: SCB\n Bearbetning: Thomas Lassi, Region Dalarna",
                    #skickad_filter_OR_vect = NA,
                    #skickad_filter_OR_var = "Marknadsandel.för.kollektivtrafik..andel....",
                    #diagram_facet = FALSE,
...
etab2 <- SkapaStapelDiagram(skickad_df = etablering %>% 
                              filter(region == "Dalarnas län", år>2012, kön=="män") %>% 
                              mutate(år = as.character(år)),
                    skickad_x_var = "bakgrundsvariabel",
                    skickad_y_var = "Andel.förvärvsarbetande..ny.definition.från.och.med.2019.",
                    skickad_x_grupp = "år",
                    diagram_titel = "Arbetsmarknadsetablering (kvinnor), Dalarnas län (2013-2020)",
                    diagram_capt = " Källa: SCB\n Bearbetning: Thomas Lassi, Region Dalarna",
                    #skickad_filter_OR_vect = NA,
                    #skickad_filter_OR_var = "Marknadsandel.för.kollektivtrafik..andel....",
                    #diagram_facet = FALSE,
...
etab3 <- SkapaStapelDiagram(skickad_df = etablering %>% 
                              filter(region == "Dalarnas län", år>2012, kön=="kvinnor") %>% 
                              mutate(år = as.character(år)),
                    skickad_x_var = "bakgrundsvariabel",
                    skickad_y_var = "Andel.förvärvsarbetande..ny.definition.från.och.med.2019.",
                    skickad_x_grupp = "år",
                    diagram_titel = "Arbetsmarknadsetablering (män), Dalarnas län (2013-2020)",
                    diagram_capt = " Källa: SCB\n Bearbetning: Thomas Lassi, Region Dalarna",
                    #skickad_filter_OR_vect = NA,
                    #skickad_filter_OR_var = "Marknadsandel.för.kollektivtrafik..andel....",
                    #diagram_facet = FALSE,
...
etab4 <- SkapaStapelDiagram(skickad_df = etablering %>% 
                               mutate(år = as.character(år)) %>% 
                              filter(år=="2020", kön=="män och kvinnor", bakgrundsvariabel == "10- år") %>% 
                              mutate( fokus = ifelse( region == "Dalarnas län", "1", "0")),
                    skickad_x_var = "region",
                    skickad_y_var = "Andel.förvärvsarbetande..ny.definition.från.och.med.2019.",
                    #skickad_x_grupp = "region",
                    diagram_titel = "Arbetsmarknadsetablering efter vistelsetid, Sverige (2020)",
                    diagram_capt = " Källa: SCB\n Bearbetning: Thomas Lassi, Region Dalarna",
                    #skickad_filter_OR_vect = NA,
                    #skickad_filter_OR_var = "Marknadsandel.för.kollektivtrafik..andel....",
                    #diagram_facet = FALSE,
...
forsk1 <- SkapaStapelDiagram(skickad_df = forskning %>% 
                    ...
                    #skickad_filter_OR_var = "region",
                    #skickad_filter_OR_vect = c("Dalarnas län"),
                    diagram_titel = "Investeringar i FoU, Dalarnas län (2011-2019)",
                    output_mapp = "Diagram/",
                    filnamn_diagram = "forskning1.png",
                    diagram_capt = " Källa: Kolada\n Bearbetning: Thomas Lassi, Region Dalarna\n Förklaring: Investeringar inkluderar företagens utgifter för egen FoU, offentliga sektorns utgifter för FoU samt universitet och högskolesektorns utgifter för FoU.",
                    #diagram_liggande = TRUE,
...
forsk2 <- SkapaStapelDiagram(skickad_df = forskning %>%
                    ...
                    diagram_capt = " Källa: Kolada\n Bearbetning: Thomas Lassi, Region Dalarna\n Förklaring: Investeringar inkluderar företagens utgifter för egen FoU, offentliga sektorns utgifter för FoU samt universitets- och högskolesektorns utgifter för FoU.",
                    #diagram_liggande = TRUE,
                    manual_y_axis_title = "Kronor/invånare",
                    x_axis_lutning = 0,
                    #manual_x_axis_text_hjust = 1.1,
...
forsk3 <- SkapaStapelDiagram(skickad_df = forskning %>% 
                    ...
                    skickad_filter_OR_var = "year",
                    skickad_filter_OR_vect = c("2019"),
                    diagram_titel = "Investeringar i FoU, Sverige (2019)",
                    output_mapp = "Diagram/",
...
bodd1 <- SkapaStapelDiagram(skickad_df = trang %>% 
                          ...
                          select(region, Samtliga.i.befolkningen, år) %>% 
                          mutate(år=as.character(år)),
                    skickad_x_var = "år",
                    skickad_y_var = "Samtliga.i.befolkningen",
                    #skickad_filter_OR_var = "region",
                    #skickad_filter_OR_vect = c("Dalarnas län"),
                    diagram_titel = "Antal trångbodda, Dalarnas län (2012-2020)",
                    output_mapp = "Diagram/",
                    filnamn_diagram = "bodd1.png",
                    diagram_capt = "Källa: SCB\nBearbetning: Thomas Lassi, Region Dalarna\nFörklaring: Antal personer boende i flerbostadshus exklusive specialbostäder trångbodda enligt norm 2, dividerat med antal personer boende i flerbostadshus exklusive specialbostäder, multiplicerat med 100 för redovisning i procent. Specialbostäder avser studentbostäder, bostäder för äldre/funktionshindrade och övriga specialbostäder. Norm 2, skapades 1965. Hushållet räknas som trångbott om det bor mer än två personer per rum (kök och vardagsrum oräknade). Personer i ensamhushåll räknas inte som trångbodda.",
                    #diagram_liggande = TRUE,
                    manual_y_axis_title = "",
                    x_axis_lutning = 0,
                    #manual_x_axis_text_hjust = 1.1,
...
boende1 <- SkapaStapelDiagram(skickad_df = boende %>% 
                          ...
                          "småhus..äganderätt", "småhus..bostadsrätt", "småhus..äganderätt"), names_to="Kategori", values_to="Antal"),
                    skickad_x_var = "Kategori",
                    skickad_y_var = "Antal",
                    skickad_x_grupp = "år",
                    #skickad_filter_OR_var = "region",
                    #skickad_filter_OR_vect = c("Dalarnas län"),
                    diagram_titel = "Boendetyper, Dalarnas län (2012-2020)",
                    output_mapp = "Diagram/",
...
till1 <- SkapaStapelDiagram(skickad_df = service %>% mutate(year = as.character(year)),
                    ...
                    skickad_y_var = "value",
                    skickad_x_grupp = "kpi",
                    diagram_titel = "Tillgång till service och tjänster, Dalarnas län (2010-2020)",
                    output_mapp = "Diagram/",
...
del1 <- SkapaStapelDiagram(skickad_df = deltagande %>% mutate(year = as.character(year)),
                    ...
                    skickad_y_var = "value",
                    skickad_x_grupp = "gender",
                    diagram_titel = "Lågt socialt deltagande, Dalarnas län (2007-2020)",
                    output_mapp = "Diagram/",
...
bred1 <- SkapaStapelDiagram(skickad_df = bredband %>% mutate(year = as.character(year)),
                    skickad_x_var = "year",
                    skickad_y_var = "Tillgång.till.bredband.om.minst.100.Mbit.s..andel....",
                    #skickad_filter_OR_var = "region",
                    #skickad_filter_OR_vect = c("Dalarnas län"),
...
valar <- c("1998", "2002", "2006", "2010", "2014", "2018")

val1 <- SkapaStapelDiagram(skickad_df = valdeltagande %>% select(-municipality) %>% mutate(year = as.character(year)) %>% filter(year %in% valar),
                    skickad_x_var = "year",
                    skickad_y_var = "Valdeltagande.i.senaste.kommunalvalet..andel....",
                    diagram_titel = "Valdeltagande i kommunval, Dalarnas län (1998-2020)",
                    output_mapp = "Diagram/",
...
val2 <- SkapaStapelDiagram(skickad_df = valdeltagande %>% select(-municipality) %>% mutate(year = as.character(year)) %>% filter(year %in% valar),
                    skickad_x_var = "year",
                    skickad_y_var = "Valdeltagande.i.senaste.regionvalet..andel....",
                    diagram_titel = "Valdeltagande i regionval, Dalarnas län (1998-2020)",
                    output_mapp = "Diagram/",
...
val3 <- SkapaStapelDiagram(skickad_df = valdeltagande %>% select(-municipality) %>% mutate(year = as.character(year)) %>% filter(year %in% valar),
                    skickad_x_var = "year",
                    skickad_y_var = "Valdeltagande.i.senaste.riksdagsvalet..andel....",
                    diagram_titel = "Valdeltagande i riksdagsval, Dalarnas län (1998-2020)",
                    output_mapp = "Diagram/",
...
till1 <- SkapaStapelDiagram(skickad_df = tillit %>% mutate(year = as.character(year)),
                    ...
                    skickad_x_grupp = "gender",
                    diagram_titel = "Avsaknad av tillit till andra, Dalarnas län (2007-2021)",
                    output_mapp = "Diagram/",
                    diagram_capt = " Källa: Kolada\n Bearbetning: Thomas Lassi, Region Dalarna",
...
ut2 <- SkapaStapelDiagram(skickad_df = utsatt %>% mutate(year = as.character(year)) %>% 
                    ...
                    skickad_x_var = "municipality",
                    skickad_y_var = "value",
                    diagram_titel = "Ekonomisk utsatthet (0-19 år), Sverige (2020)",
                    output_mapp = "Diagram/",
...
unga1 <- SkapaStapelDiagram(skickad_df = ungadel %>% 
                    ...
                    skickad_y_var = "andel",
                    skickad_x_grupp = "År",
                    diagram_titel = "Ungas delaktighet, Dalarna (2015-2021)",
                    output_mapp = "Diagram/",
...
halsa2 <- SkapaStapelDiagram(skickad_df = hlv %>% 
                                  filter(Fråga=="Allmänt hälsotillstånd - Bra eller mycket bra hälsa", Kön=="Totalt", År=="2021", Kommun!="Dalarna") %>% 
                                  mutate( fokus = ifelse( Kommun == "Riket", "1", "0" ) ),
                    skickad_x_var = "Kommun",
                    skickad_y_var = "Andel",
                    #skickad_x_grupp = "Kommun",
                    diagram_titel = "Självskattat allmänt hälsotillstånd, Dalarnas län (2021)",
                    output_mapp = "Diagram/",
