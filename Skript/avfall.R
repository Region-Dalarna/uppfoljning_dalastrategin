...
### Endast det toala antalet invånare i Dalarna behövs
avfall <- avfall[avfall$gender=="T",]

### Ta bort kolumner som vi inte behöver
avfall$municipality_id <- NULL
avfall$municipality <- NULL
avfall$gender <- NULL
avfall$count <- NULL
avfall$municipality_type <- NULL
