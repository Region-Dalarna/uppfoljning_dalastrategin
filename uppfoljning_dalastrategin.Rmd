...
Av rapporten framgår att för flera av miljömålen är klimatförändring ett av de stora hoten. Negativa effekter av ett förändrat klimat så som värmeböljor, torka, extrema skyfall, översvämning, ras, skred och erosion och skogsbränder kommer att innebära en omfattande utmaning för samhället.
...
<span class="big-indicator">
Ohälsa hos arbetande <span style="color:red; font-size:1.8em; font-weight:900;">⬇</span>
</span>
<br>
...
Kommentera individuella programmet?
...
<span class="big-indicator">
Arbete och företagande <span style="color:red; font-size:1.8em; font-weight:900;">⬇</span>
</span>
<br>
...
<span class="big-indicator">
Förutsättningar <span style="color:red; font-size:1.8em; font-weight:900;">⬇</span>
</span>
<br>

<span class="big-indicator">
Ekobrottslighet <span style="color:red; font-size:1.8em; font-weight:900;">⬇</span>
</span>
<br>
...
Från TVV - företagens villkor och verklighet och Entreprenörskapsforums rapport.
...
https://www.trafa.se/globalassets/statistik/bantrafik/punktlighet-pa-jarnvag/2026/punktlighet-pa-jarnvag-2025-statistikblad.html

<!--
**Energitillgång?**

Tillförlitligheten i energi-systemet, har frågat Jessica men hittar inget bra sätt att mäta det, får undersöka vidare.
...
<span class="big-indicator">
Regionala inkomster <span style="color:red; font-size:1.8em; font-weight:900;">⬇</span>
</span>
<br>
...
## Dalfolkets hälsa, trygghet och tillit {.tabset}
...
<span class="big-indicator">
Hälsa och folksjukdomar <span style="color:red; font-size:1.8em; font-weight:900;">⬇</span>
</span>
<br>


<span class="big-indicator">
Trygghet och brott <span style="color:red; font-size:1.8em; font-weight:900;">⬇</span>
</span>
<br>
...
## Dalfolkets delaktighet och samhällsengagemang {.tabset}
...
```
Här kommer fler variabler om deltagande att läggas till.
<!--
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height=5, fig.width=8, fig.align='center'}
gg_service_vard$service_Dalarna
```

```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height=5, fig.width=8, fig.align='center'}
gg_service_vard$vard_Dalarna
```
